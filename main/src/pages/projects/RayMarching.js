...
// const components = {
//   A1: () => <RayMarchingCanvas.A1 />,
//   A2: () => <RayMarchingCanvas.A2 />,
//   A3: () => <RayMarchingCanvas.A3 />,
//   B1: () => <RayMarchingCanvas.B1 />,
//   B2: () => <RayMarchingCanvas.B2 />,
//   B3: () => <RayMarchingCanvas.B3 />,
// };
...
//   return (
//     <div className="relative w-full h-[calc(100vh)] bg-white flex justify-center">
...
//           and effects such as fractals, volumetric clouds and soft shadows. Ray
//           marching is commonly used in combination with signed distance
//           functions (SDFs) to represent objects in the scene. <br />
//           <br />
//           In this project, I will be implementing a simple ray marching renderer
//           using the Three.js library. I will explore different rendering
//           techniques such as distance field rendering, volumetric rendering and
//           ambient occlusion to create visually appealing scenes.
//         </p>
//         <div className="flex flex-wrap justify-center items-center gap-5 w-full mt-5">
//           {components[activeTab]()}
//         </div>
//         <div className="flex justify-center gap-3 p-3 bg-gray-200 rounded-bl-lg rounded-br-lg">
